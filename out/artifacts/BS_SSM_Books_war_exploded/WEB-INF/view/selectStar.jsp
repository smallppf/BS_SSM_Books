                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <c:forEach items="${data}" var="i">
                                                    <li><a href="/selectStar/${i.name}">${i.name}</a></li>
                                                </c:forEach>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail" style="background-color: #b2dbde">
                            ...
                            <div class="caption">
                                ...
                                <p>${i.autho}</p>
                                <p>
                                    <a href="/delStar/${i.bid}" class="btn btn-danger" role="button">移出收藏</a>
